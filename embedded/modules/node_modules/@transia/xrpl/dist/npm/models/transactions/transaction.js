...
const contractClawback_1 = require("./contractClawback");
const contractCreate_1 = require("./contractCreate");
const contractDelete_1 = require("./contractDelete");
const contractModify_1 = require("./contractModify");
const contractUserDelete_1 = require("./contractUserDelete");
...
function validate(transaction) {
    ...
    switch (tx.TransactionType) {
        ...
        case 'Clawback':
            ...
            break;
        case 'ContractCall':
            (0, contractCall_1.validateContractCall)(tx);
            break;
        case 'ContractClawback':
            (0, contractClawback_1.validateContractClawback)(tx);
            break;
        case 'ContractCreate':
            (0, contractCreate_1.validateContractCreate)(tx);
            break;
        case 'ContractDelete':
            (0, contractDelete_1.validateContractDelete)(tx);
            break;
        case 'ContractModify':
            (0, contractModify_1.validateContractModify)(tx);
            break;
        case 'ContractUserDelete':
            (0, contractUserDelete_1.validateContractUserDelete)(tx);
            break;
