...
import { ContractClawback } from './contractClawback';
import { ContractCreate } from './contractCreate';
import { ContractDelete } from './contractDelete';
import { ContractModify } from './contractModify';
import { ContractUserDelete } from './contractUserDelete';
...
export type SubmittableTransaction = AMMBid | AMMClawback | AMMCreate | AMMDelete | AMMDeposit | AMMVote | AMMWithdraw | AccountDelete | AccountSet | Batch | CheckCancel | CheckCash | CheckCreate | Clawback | ContractCall | ContractClawback | ContractCreate | ContractDelete | ContractModify | ContractUserDelete | CredentialAccept | CredentialCreate | CredentialDelete | DIDDelete | DIDSet | DelegateSet | DepositPreauth | EscrowCancel | EscrowCreate | EscrowFinish | MPTokenAuthorize | MPTokenIssuanceCreate | MPTokenIssuanceDestroy | MPTokenIssuanceSet | NFTokenAcceptOffer | NFTokenBurn | NFTokenCancelOffer | NFTokenCreateOffer | NFTokenMint | NFTokenModify | OfferCancel | OfferCreate | OracleDelete | OracleSet | Payment | PaymentChannelClaim | PaymentChannelCreate | PaymentChannelFund | PermissionedDomainSet | PermissionedDomainDelete | SetRegularKey | SignerListSet | TicketCreate | TrustSet | VaultClawback | VaultCreate | VaultDelete | VaultDeposit | VaultSet | VaultWithdraw | XChainAccountCreateCommit | XChainAddAccountCreateAttestation | XChainAddClaimAttestation | XChainClaim | XChainCommit | XChainCreateBridge | XChainCreateClaimID | XChainModifyBridge;
