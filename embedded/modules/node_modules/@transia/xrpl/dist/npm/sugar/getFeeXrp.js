...
function getGasEstimate(client, txBlob) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (typeof response.result.meta !== 'object') {
            throw new errors_1.XrplError('getGasEstimate: Could not get meta from simulate response');
        }
        const meta = response.result.meta;
        if (typeof meta.GasUsed !== 'number') {
            throw new errors_1.XrplError('getGasEstimate: GasUsed in simulate response is not a number');
        }
