...
exports.autofillBatchTxn = exports.handleDeliverMax = exports.checkAccountDeleteBlockers = exports.setLatestValidatedLedgerSequence = exports.getComputationAllowance = exports.getTransactionFee = exports.setNextValidSequenceNumber = exports.setValidAddresses = exports.txNeedsNetworkID = void 0;
...
const getFeeXrp_1 = __importStar(require("./getFeeXrp"));
...
function getComputationAllowance(client, tx) {
    return __awaiter(this, void 0, void 0, function* () {
        const copyTx = Object.assign({}, tx);
        delete copyTx.SigningPubKey;
        const tx_blob = (0, ripple_binary_codec_1.encode)(copyTx);
        tx.ComputationAllowance = yield (0, getFeeXrp_1.getGasEstimate)(client, tx_blob);
    });
}
exports.getComputationAllowance = getComputationAllowance;
